...
fn set_sale_history() {
  ...
  setup_contract(deps.as_mut());
  let info = mock_info("owner", &[]);
  let msg = ExecuteMsg::SetSaleHistory { 
    address: "juno1xcnjcqes5qdyys0ewr99w6salalaa6st4w3sqcephp6f9uh9qhdsnnarsw".to_string(), 
    history: vec![SaleInfo
      {
        from:"juno1p3dcg6mhxe0nhfuw73jy9fwhsk9ekwm6z65pyh".to_string(),
        to:"juno1ye65jcc6fwp5ugddfqj0gtgj0d8e0v9t7l56e6".to_string(),
        denom:"ujuno".to_string(),
        amount:Uint128::new(6090000),
        time:"1657720765".to_string(),
        collection:"juno1xcnjcqes5qdyys0ewr99w6salalaa6st4w3sqcephp6f9uh9qhdsnnarsw".to_string(),
        token_id:"BAIC.274".to_string()
      },
       SaleInfo{
        from:"juno1a4lkk7p7dxpdy0a72pl05lngt830j2wlf2xtkp".to_string(),
        to:"juno18nvzkc48042mkks8p98nk7dsrmzygsdqgfu7ag".to_string(),
        denom:"ujuno".to_string(),
        amount:Uint128::new(380000),
        time:"1657584558".to_string(),
        collection:"juno1xcnjcqes5qdyys0ewr99w6salalaa6st4w3sqcephp6f9uh9qhdsnnarsw".to_string(),
        token_id:"BAIC.342".to_string()
        }
  ...
  let sale_hisotry = query_sale_history_by_seller(deps.as_ref(), "juno1p3dcg6mhxe0nhfuw73jy9fwhsk9ekwm6z65pyh".to_string(), None, Some(20)).unwrap();
  println!("{:?}",sale_hisotry);

}



//Some(SaleHistoryOffset{
  //   token_id: "BAIC.274".to_string(),
  //   time: 1657720765
  // })